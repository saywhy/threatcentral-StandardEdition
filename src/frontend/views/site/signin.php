            ...
            <div class="col-md-6" style="position: relative;height: 100%;">
                ...
                <div class="login_box_content">
                    ...
                    <div class="input_box">
                        ...
                        <input id="username" class="input_css" placeholder="请输入用户名" type="text" ng-model="user.username"
                    ...
                    <div class="input_box">
                        ...
                        <input id="pswd" class="input_css" ng-focus="password_focus()" placeholder="请输入密码"
                    ...
                    <div class="input_box">
                        ...
                        <div>
                            <input id="code" class="input_css" ng-focus="code_focus()" style="width:210px;"
                                placeholder="验证码" type="text" ng-model="user.code">
                    ...
                    <div>
                        <img src="/images/login/select_o.png" class="img_rem" ng-click="select(1)" ng-if="select_if"
                            alt="">
                        <img src="/images/login/select_i.png" class="img_rem" ng-click="select(2)" ng-if="!select_if"
                            alt="">
                ...
                <div style="color:#999;position:absolute;left:50%;transform: translate(-50%);bottom:30px;">
