...
$this->title = '添加用户';
?>
<link rel="stylesheet" href="/css/set/adduser.css">
<section class="adduser_content" ng-app="myApp" ng-controller="AddUserController" ng-cloak>
    <div class="user_box">
        <div class="user_box_item">
            <span class="user_box_item_title">用户名</span>
            <input type="text" class="user_box_item_input" ng-model="new_user.username">
        </div>
        <div class="user_box_item">
            <span class="user_box_item_title">设置密码</span>
            <input type="password" class="user_box_item_input"
            placeholder="{{password_placeholder}}"  ng-model="new_user.password">
        </div>
        <div class="user_box_item">
            <span class="user_box_item_title">确认密码</span>
            <input type="password" class="user_box_item_input"
            placeholder="{{password_placeholder}}" ng-model="new_user.repeat_password">
        </div>
        ...
        <div class="user_box_item">
            ...
            <input type="text" class="user_box_item_input" placeholder="允许最多指定5个IP地址,每个地址用‘;’隔开" ng-model="new_user.allow_ip">
        </div>
        <div>
...
<script type="text/javascript" src="/js/controllers/set/user/adduser.js"></script>
